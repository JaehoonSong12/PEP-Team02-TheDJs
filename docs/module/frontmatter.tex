...
\begin{tabularx}{\textwidth}{@{} c c l X @{}}
  ...
  \midrule
  0.1 & 10 June 2026 & The DJs & LaTeX structure, Phase~1 task breakdown, ERD, Definition of Done, and Task Backlog \\
  0.2 & 11 June 2026 & The DJs & Phase~1 API Contract HTTP request/response trace documentation (payloads and status codes) \\
  \bottomrule
\end{tabularx}
