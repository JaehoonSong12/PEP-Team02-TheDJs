...
\subsection{Deliverables for Phase 4}
...
\subsection{Moving to Phase 5}
Once the frontend is fully integrated and all user stories are functional,
proceed to \textbf{Phase 5: Presentation}.

\newpage
\subsection{Project Scaffolding}\label{sec:fe-scaffolding}
Initialize Angular and configure environment settings.
See deliverable checklist in Section~\ref{sec:phase4}.

\newpage
\subsection{Service Layer}\label{sec:service-layer}
Build Angular services to consume the Spring Boot API.
See deliverable checklist in Section~\ref{sec:phase4}.

\newpage
\subsection{Auth Integration}\label{sec:auth-integration}
Implement login/register forms and JWT-based state management.
See deliverable checklist in Section~\ref{sec:phase4}.

\newpage
\subsection{Task Management UI}\label{sec:task-ui}
Build the dashboard, task creation forms, and subtask nested lists.
See deliverable checklist in Section~\ref{sec:phase4}.

\newpage
\subsection{Design Validation}\label{sec:fe-design-validation}
Confirm the UI components and user workflows match the Phase~2 wireframes.
See deliverable checklist in Section~\ref{sec:phase4}.

\newpage
\subsection{Functional Angular Application}\label{sec:functional-angular}
Document the complete, running frontend integrated with the backend.
See deliverable checklist in Section~\ref{sec:phase4}.

\newpage
\subsection{End-to-End Workflow}\label{sec:e2e-workflow}
Demonstrate that a user can successfully register, log in, manage todos, and manage subtasks without errors.
See deliverable checklist in Section~\ref{sec:phase4}.

\newpage
\subsection{Verified UI/UX}\label{sec:verified-ui}
Document a UI that matches the wireframes and provides a smooth, intuitive user experience.
See deliverable checklist in Section~\ref{sec:phase4}.
