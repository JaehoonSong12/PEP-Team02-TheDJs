...
- [x] 1. Set up test package structure and verify jqwik dependency
  - [x] 1.1 Create test sub-package directories and verify build configuration
...
- [x] 2. Implement RegistrationService unit tests
  - [x] 2.1 Create RegistrationServiceTest with username validation and password validation nested groups
  ...
  - [x] 2.2 Add duplicate checking and persistence nested groups to RegistrationServiceTest
...
- [x] 3. Implement UserService unit tests
  - [x] 3.1 Create UserServiceTest with login nested group
...
- [x] 4. Implement TaskService unit tests
  - [x] 4.1 Create TaskServiceTest with createTask and getTasksForUser nested groups
  ...
  - [x] 4.2 Add getTaskById, updateTask, and deleteTask nested groups to TaskServiceTest
...
- [x] 5. Checkpoint - Verify service tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 6. Implement PasswordValidator unit tests
  - [x] 6.1 Create PasswordValidatorTest with individual rules and boundary tests
...
- [x] 7. Implement JwtUtil unit tests
  - [x] 7.1 Create JwtUtilTest with generateToken, extractUsername, extractUserId, and isTokenValid nested groups
...
- [x] 8. Implement AuthInterceptor unit tests
  - [x] 8.1 Create AuthInterceptorTest with CORS, header validation, token validation, and success nested groups
...
- [x] 9. Checkpoint - Verify security tests pass
  - Ensure all tests pass, ask the user if questions arise.
